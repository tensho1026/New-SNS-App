      ...
      <main className="container mx-auto px-4 py-6">
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <div>
                    <Link href="/profile/user1" className="font-bold text-gray-900 dark:text-white hover:underline">
                      山田太郎
                    </Link>
                    <div className="text-sm text-gray-500 dark:text-gray-400">@yamada_taro</div>
                  </div>
                ...
                <p className="mt-2 text-gray-800 dark:text-gray-200 text-lg">
                  これは投稿ID: {params.postId} の詳細ページです。ここに投稿の詳細な内容が表示されます。
                ...
                <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">午後3:24 · 2023年4月15日</div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-4">
            <h2 className="font-bold text-lg text-gray-900 dark:text-white mb-4">コメント</h2>
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((comment) => (
                ...
                >
                  ...
                  >
                    <img src={`/placeholder.svg?height=40&width=40&text=User${comment}`} alt="User avatar" />
                  </Link>
                  <div className="flex-1">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">@commenter{comment}</span>
                      <span className="mx-1 text-gray-500 dark:text-gray-400">·</span>
                      <span className="text-sm text-gray-500 dark:text-gray-400">{comment}時間前</span>
                    </div>

                    <p className="mt-1 text-gray-800 dark:text-gray-200">
                      これはコメント{comment}です。投稿に対するコメントがここに表示されます。
                      {comment === 2 && " 長めのコメント内容もこのように表示されます。"}
                    </p>
